...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  EventName.carUnrecognized: {
    ET.PERMANENT: NormalPermanentAlert("目前处于行车记录模式",
  ...
  EventName.cameraFrameRate: {
    ET.PERMANENT: NormalPermanentAlert("Camera Frame Rate Low", "请尝试重启设备"),
    ET.SOFT_DISABLE: soft_disable_alert("Camera Frame Rate Low"),
    ET.NO_ENTRY: NoEntryAlert("Camera Frame Rate Low: 请尝试重启设备"),
  },
